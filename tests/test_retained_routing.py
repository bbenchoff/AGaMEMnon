...
@pytest.mark.parametrize('pip', [
    ...
    'X19Y12_RMUX92.X19Y11_RMUX74',  # bottom-boundary downward turnback
    'X18Y10_RMUX93.X19Y10_RMUX87',  # column-boundary rightward turnback
    'X17Y10_RMUX69.X17Y10_RMUX87',  # unsupported same-tile translation
    'X17Y9_RMUX33.X18Y9_RMUX39',  # column-boundary rightward turnback
    'X18Y10_RMUX69.X18Y9_RMUX83',  # row-boundary downward turnback
    'X18Y10_RMUX85.X18Y9_RMUX65',  # unsupported downward turnback
    'X19Y10_RMUX61.X18Y10_RMUX54',  # column-boundary leftward turnback
    'X19Y8_RMUX31.X18Y8_RMUX25',  # disproven leftward translation
    'X20Y9_RMUX49.X20Y9_RMUX07',  # boundary-column same-tile translation
    'X17Y10_RMUX92.X17Y9_RMUX81',  # unsupported downward translation
])
