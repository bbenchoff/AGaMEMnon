...
def test_serv_write_ingress_is_an_atomic_qualified_footprint():
    ...
    assert paths == {
        "DataInA[0]": [
            (0, "X14Y4_OMUX14", "X14Y4_RMUX32"),
            (1, "X14Y4_RMUX32", "X14Y7_RMUX27"),
            (2, "X14Y7_RMUX27", "X14Y4_RMUX15"),
            (3, "X14Y4_RMUX15", "X15Y4_RMUX63"),
            (4, "X15Y4_RMUX63", "X13Y4_RMUX52"),
            (5, "X13Y4_RMUX52", "X13Y4_IMUX30"),
        ],
        "DataInA[1]": [
            (0, "X14Y4_OMUX41", "X14Y4_RMUX74"),
            (1, "X14Y4_RMUX74", "X15Y4_RMUX03"),
            (2, "X15Y4_RMUX03", "X13Y4_RMUX05"),
            (3, "X13Y4_RMUX05", "X13Y4_IMUX29"),
        ],
        "WeA": [
            (0, "X15Y4_OMUX02", "X15Y4_RMUX02"),
            (1, "X15Y4_RMUX02", "X15Y5_RMUX08"),
            (2, "X15Y5_RMUX08", "X16Y5_RMUX27"),
            (3, "X16Y5_RMUX27", "X16Y4_RMUX20"),
            (4, "X16Y4_RMUX20", "X13Y4_TMUX13"),
            (5, "X13Y4_TMUX13", "X13Y4_KMUX03"),
        ],
    }
    uarch = open(os.path.join(
        ROOT, "agamemnon", "engine", "uarch", "agrv2k", "agrv2k.cc"),
