...
def test_hint_on_lut_output_does_not_redirect_it_to_the_active_register():
    assert prepare(0, True, init=0x5555, routed_outputs=(2,), f_outputs=(0,)).register_sets == [(200, 4)]
