...
def test_supplemental_corridors_do_not_restore_nonportable_selector(emitted_graphs):
    for directory in emitted_graphs:
        ...
        assert ("X17Y9_RMUX50", "X17Y10_RMUX08") not in edges
        assert ("X17Y2_RMUX50", "X17Y3_RMUX08") in edges
        assert ("X17Y11_RMUX50", "X17Y10_RMUX08") in edges
        ...
        assert ("X15Y9_RMUX87", "X15Y9_RMUX68") not in edges
        assert ("X15Y2_RMUX87", "X15Y2_RMUX68") in edges
        assert ("X15Y5_RMUX39", "X15Y9_RMUX68") in edges
