...
| UART | 5 hard instances plus open polling HAL and internal-loopback example | `uart_tx.v`, 8N1 transmitter | UART0 internal-loopback echoed byte 0xA5. Separate external routes qualify PIN_10 TX and PIN_31 RX: independent Pico PIO and DAP CDC endpoints transferred 64/64 exact bytes at 9600, 38400, and 115200 nominal baud. Simultaneous duplex, flow control, FIFO/error stress, UART1–4, and sub-percent absolute calibration remain open; FPGA combined simulation passes |
