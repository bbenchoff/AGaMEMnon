...
The 2026-08-24 campaign is the strongest practical demonstration of these
tiers. Among 105 hand-authored designs, 52 produced no qualifying image and 13
...
**`ByteEnA` byte-lane masking IS functional on silicon (2026-09-15) [S].** A
...
store in the open flow** (silicon capability UNRESOLVED — the vendor x9-write readback floated, so it is unproven either way; the BRAM write-ingress frontier — see STATUS.md and
