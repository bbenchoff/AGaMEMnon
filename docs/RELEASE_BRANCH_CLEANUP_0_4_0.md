...
Nine reviewed dirty checkouts have also been retired after preserving complete archives, patches and history. Current totals are **33 worktrees and 16 local branches**, with twenty-one remote branches retired during this consolidation. The unresolved-index checkout includes a separate verified recovery pack for its staged/conflict objects; no conflict was resolved by discarding work. Those archives were banked at AG32-Docs `577bbd1b4` before removal. The primary checkout and remaining HIL input paths remain available while their preservation and release dependencies are checked.
