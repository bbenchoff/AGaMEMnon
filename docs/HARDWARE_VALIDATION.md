...
| Physical input | L48 PIN_10, PIN_11, PIN_15, and PIN_19; registered input on PIN_19. PIN_25 is also qualified through its exact left-edge InputMUX00->RMUX11->IMUX09 corridor in a single-consumer direct inversion observed at PIN_18; this does not qualify general fanout or the complete four-link bidirectional node |
