...
| External AHB write | All 32 HWDATA lanes exercised in protocol-valid four-bit groups; HWDATA0 and HWDATA1 additionally have exact one-consumer MCU_BUS_CLOCK capture footprints, and a two-bit HADDR2-tagged posted store passes all four values, immediate/back-to-back readback, and offset isolation |
