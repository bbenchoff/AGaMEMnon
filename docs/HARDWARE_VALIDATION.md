...
| External AHB write | All 32 HWDATA lanes exercised in protocol-valid four-bit groups; HWDATA0 additionally captured under MCU_BUS_CLOCK in a complete exact-site footprint, and a one-bit posted store passes immediate and back-to-back readback |
