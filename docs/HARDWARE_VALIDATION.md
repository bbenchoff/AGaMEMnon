...
| Physical output | Characterized L48 header outputs and PIN_25 through PIN_28, including concurrent use; plus top-edge PIN_18 and PIN_16 (2026-08-15): both toggling from one ordinary-CLI image at Pico GP8 403,449 Hz and GP6 405,596 Hz, each toggling alone with the other static, neighbouring pads GP7/GP2/GP5/GP3 reading zero edges, all FCB 0x000f0002 with zero unmapped and zero predicted selectors |
