...
| External AHB write | All 32 HWDATA lanes exercised in protocol-valid four-bit groups; HWDATA0 through HWDATA4 additionally have exact one-consumer MCU_BUS_CLOCK capture footprints, and a pure-open four-bit HADDR2-tagged posted store passes all sixteen values, immediate/back-to-back readback, persistence, and offset isolation |
