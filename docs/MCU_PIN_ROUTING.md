...
| Fabric outputs `PIN_18`, `PIN_16`, `PIN_15` and `PIN_14` | Silicon-qualified | Exactly these four decimal L48 package leads, individually and in measured neighbouring-pad pairs, through the ordinary `agamemnon build <source> --pcf <constraints>`. PIN_14 is pad slot z2 and composes with PIN_16 on the shared (19,13) pad tile. This is **not** the ten-pad `PIN_10..PIN_19` ring: the other six top pads (PIN_10, PIN_11, PIN_12, PIN_13, PIN_17 and PIN_19) have no silicon observation and no entry in `agamemnon/chipdb/pad_output_qualified_L48.csv` |
