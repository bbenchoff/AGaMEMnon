...
| PIN_25 combined-cell OE/readback | Silicon-qualified exact subset | Hard-zero data with the recorded six-pip OE corridor qualifies constant release/drive-low, simultaneous static readback, and local-self-toggle dynamic OE. External PIN_10-controlled OE, simultaneous dynamic readback, generic/open-drain/registered OE, other pins, and other corridors remain unqualified |
