...
| Fabric outputs `PIN_18`, `PIN_16`, `PIN_15`, `PIN_14` and `PIN_13` | Silicon-qualified | Exactly these five decimal physical L48 package leads, individually and in measured neighbouring-pad compositions, through the ordinary `agamemnon build <source> --pcf <constraints>`. PIN_13 is pad slot z3 and composes with PIN_16 on the shared (19,13) pad tile; both remain toggling under opposite Pico pulls while weak neighbouring pickup does not. This is **not** the ten-pad `PIN_10..PIN_19` ring: PIN_10, PIN_11, PIN_12, PIN_17 and PIN_19 have no output qualification and no entry in `agamemnon/chipdb/pad_output_qualified_L48.csv` |
