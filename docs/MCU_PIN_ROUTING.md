...
| Fabric outputs `PIN_18`, `PIN_16`, `PIN_15`, `PIN_14`, `PIN_13`, `PIN_17` and `PIN_19` | Silicon-qualified | Exactly these seven decimal physical L48 package leads, individually and in measured neighbouring-pad compositions, through the ordinary `agamemnon build <source> --pcf <constraints>`. PIN_17 composes with PIN_18 on pad tile (18,13); PIN_19 composes with PIN_16 across pad tiles. Both new pairs and their single-pad controls remain toggling under opposite Pico pulls only on the intended leads, and production rebuilds are byte-identical to the measured images. This is **not** the ten-pad `PIN_10..PIN_19` ring: PIN_10, PIN_11 and PIN_12 have no output qualification and no entry in `agamemnon/chipdb/pad_output_qualified_L48.csv`. `PIN_n` is a decimal package-lead label, not hexadecimal indexing |
