...
BEL/cell metadata cover X13Y1 through X13Y4. A simultaneous marker image proves
all four hard arrays can read distinct Port-A bytes on silicon. The harvested
