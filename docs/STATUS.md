...
| Dedicated carry | Silicon-qualified exact subsets | Same-tile short chains and exact seams; the corrected X20Y12->Y11->Y10 33-site corridor has two native counter-rate witnesses at 10 MHz. The old upward/skipping 33-site topology is withdrawn. Other columns, placements, arbitrary wide arithmetic and Fmax remain open. See [carry corridor correction](CARRY_CORRIDOR_CORRECTION.md). |
