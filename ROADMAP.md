...
2. **Closed for the cause-17 and cause-18 command subsets:** an AHB write-command bank now
   ...
   16–19 remain qualified; widening command state to causes 16 and 19 is open.
