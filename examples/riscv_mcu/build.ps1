...
Build-Example "gptimer_pwm.c" "link_sram.ld" "gptimer_pwm"
Build-Example "can_selftest.c" "link_sram.ld" "can_selftest"
Build-Example "i2c_probe.c" "link_sram.ld" "i2c_probe"
Build-Example "spi_loopback.c" "link_sram.ld" "spi_loopback"
Build-Example "analog_probe.c" "link_sram.ld" "analog_probe"
