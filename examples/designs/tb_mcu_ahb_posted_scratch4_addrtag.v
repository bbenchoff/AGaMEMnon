...
module tb_mcu_ahb_posted_scratch4_addrtag;
  ...
  task write0(input [3:0] value); begin
  ...
  initial begin
    ...
    for (value=0; value<16; value=value+1) begin
      write0(value[3:0]);
      if (hrdata !== value[3:0]) $fatal(1, "value %0d", value);
    end
    ...
    $display("PASS: four-bit posted scratch address-tag forwarding");
    $finish;
  end
endmodule
