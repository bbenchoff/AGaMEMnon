...
module tb_mcu_ahb_posted_scratch7_addrtag;
  ...
  task write0(input [6:0] value); begin
  ...
  initial begin
    ...
    $display("PASS: seven-bit posted scratch address-tag forwarding");
    $finish;
  end
endmodule
