...
module tb_mcu_ahb_posted_scratch5_addrtag;
  ...
  task write0(input [4:0] value); begin
  ...
  initial begin
    ...
    for (value=0; value<32; value=value+1) begin
      write0(value[4:0]);
      if (hrdata !== value[4:0]) $fatal(1, "value %0d", value);
    end
    ...
    $display("PASS: five-bit posted scratch address-tag forwarding");
    $finish;
  end
endmodule
