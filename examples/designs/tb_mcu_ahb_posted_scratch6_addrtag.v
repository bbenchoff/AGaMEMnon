...
module tb_mcu_ahb_posted_scratch6_addrtag;
  ...
  task write0(input [5:0] value); begin
  ...
  initial begin
    ...
    for (value=0; value<64; value=value+1) begin
      write0(value[5:0]);
      if (hrdata !== value[5:0]) $fatal(1, "value %0d got %0h", value, hrdata);
    end
    ...
    $display("PASS: six-bit posted scratch address-tag forwarding");
    $finish;
  end
endmodule
