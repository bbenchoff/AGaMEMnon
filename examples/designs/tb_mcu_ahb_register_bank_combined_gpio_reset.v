`timescale 1ns/1ps
module tb_mcu_ahb_register_bank_combined_gpio_reset;
  reg hclk=0; always #5 hclk=~hclk;
  reg htrans1=0, hwrite=0, haddr2=0, haddr3=0, reset_request=1;
  reg [7:0] hwdata=0;
  wire hreadyout, hresp;
  wire [7:0] hrdata;
  agamemnon_ahb_register_bank_combined_gpio_reset_core dut(
  ...
  initial begin
    ...
    $display("PASS: GPIO-resettable combined ID/scratch/counter/W1C bank");
    $finish;
  end
endmodule
