...
module tb_mcu_ahb_posted_scratch8_addrtag;
  ...
  task write0(input [7:0] value); begin
  ...
  initial begin
    ...
    $display("PASS: eight-bit posted scratch address-tag forwarding");
    $finish;
  end
endmodule
