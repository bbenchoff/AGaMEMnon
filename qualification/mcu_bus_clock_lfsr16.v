// Long-period bus-clock state source for timer-correlated rate measurement.
module top;
  wire bus_clock;
  ...
  // XNOR form of x^16 + x^14 + x^13 + x^11 + 1. Starting from zero
  // enters the 65535-state orbit; all ones is the excluded lock state.
