...
| `mcu_ahb_register_bank_evidence.jsonl` (16-bit checkpoint) | One exact L48 held scratch passes 100 aligned word patterns, SRAM-churn retention, repeated reads, one wait and GPIO reset across HRDATA[15:0]. Address isolation, subword access, upper HRDATA lanes, bursts, arbitrary placement/width and public-bank integration remain unqualified. |
