...
/*
 * SRAM-only UART0 receive oracle.  The matching fabric image presents the
 * board DAP-UART TX lead (L48 PIN_31) to GPIO6.1/UART0_UARTRXD.  The host
 * writes baud to mailbox[3] and then arms the receive loop with mailbox[5].
 */
int main(void) {
