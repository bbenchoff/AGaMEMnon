// Byte-wide ID/scratch endpoint. Offset 0 returns immutable ID low byte 0x4d;
// offset 4 is the qualified posted scratch byte.
module agamemnon_ahb_id_scratch8_core (
...
module top;
  ...
  (* keep *) GENERIC_SLICE #(.K(4), .INIT(16'hAAAA), .FF_USED(1'b0))
    readback_buffer0(.CLK(hclk), .I({3'b000, readback[0]}),
                     .F(hrdata0), .Q());
  agamemnon_ahb_id_scratch8_core core_i(
