// Return-half discriminator for the nonlocal X15Y8 feedback loop.
// GPIO drives a slice4 identity LUT; its OMUX14 mesh output feeds the ordinary
// I3/F-to-Q path at slice12, whose default Q presentation is observed.
module top;
