...
from qualification.n58_hwdata25_hil_s01.classifier import (
...
def test_manifest_and_preregistration_are_valid_json() -> None:
    assert json.loads((PACKAGE / "package_manifest.json").read_text())["hardware_execution_authorized_by_this_manifest"] is False
    assert json.loads((PACKAGE / "preregistration.json").read_text())["safety"]["automatic_retry"] is False
