// Qualified source build: INIT=all ones, DataInA[1]=0, WeA=h1 via TMUX09.
module top(input clk);
  ...
  wire din1;
  (* keep *) GENERIC_SLICE #(.INIT(16'h0000), .FF_USED(1'b0))
    src_d1(.CLK(clk), .I(4'b0), .F(din1), .Q());
  wire [17:0] q;
  (* keep *) ALTA_BRAM9K #(
    .INIT_VAL({9216{1'b1}}), .PORTA_WIDTH(5'b00000), .PORTB_WIDTH(5'b00000),
