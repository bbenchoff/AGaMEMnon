...
qualified patches from `examples/usb_cdc_uploader/README.md` in the AGaMEMnon
repository. The external AGM SDK does not contain a top-level license file;
review its provenance before use or redistribution.
