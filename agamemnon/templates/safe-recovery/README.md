...
change documented in the AGaMEMnon
[UART bootloader guide](https://github.com/bbenchoff/AGaMEMnon/blob/main/docs/UART_BOOTLOADER.md)
before Pico/UART recovery works.
