...
OPTIONS = {
    ...
    "AGAMEMNON_CLEAN_SEL_GATE": _flag("both", "release", "agamemnon/chipdb/sel_edge_pairs.pkl", "Require exact conflict-free selector encodings."),
    ...
    "AGAMEMNON_CLEAN_SEL_PREFER": _flag("arch", "experimental", "agamemnon/chipdb/sel_edge_pairs.pkl", "Prefer exact encodings without gating alternatives."),
    "AGAMEMNON_CLEAN_SEL_PENALTY": _value("30", "float", "arch", "experimental", "agamemnon/chipdb/sel_edge_pairs.pkl", "Nanosecond cost for a selector without exact evidence."),
