...
def mcu_entry_first_hops(chipdb_root):
    ...
    # HADDR15/16/20 alternatives have the same three-load source-discriminating
    # evidence; HADDR30/31 rows reproduce their existing hops. Other roots keep
    # their source-specific restrictions, including the HWDATA[1] counterexample.
