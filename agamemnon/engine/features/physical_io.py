...
ARCHITECTURE_FILES = (
    ...
    # Typed ownership/legality authority for the four already-qualified
    # left-output corridors.  It shapes nextpnr resource use but owns no new
    # bitstream selector field.
    "special_routes_l48_left_output.csv",
